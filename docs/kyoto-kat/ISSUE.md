# Reference package ready for Opus 5

All 50 selected concept PNGs are generated and visually reviewed. PNG integrity, minimum 1024px
dimensions, unique hashes, all manifest paths, and SHA-256 equality to original masters passed.

- Branch: [feat/kyoto-kat-asset-workflow](https://github.com/zugzug1/vibe3d/tree/feat/kyoto-kat-asset-workflow)
- [Manifest and prompts](https://github.com/zugzug1/vibe3d/blob/feat/kyoto-kat-asset-workflow/docs/kyoto-kat/manifest.json)
- [Handoff](https://github.com/zugzug1/vibe3d/blob/feat/kyoto-kat-asset-workflow/docs/kyoto-kat/HANDOFF.md)
- Local image index: `/Volumes/zug1/kyoto-kat-kit/v1/INDEX.md`
- Local reference folder: `/Volumes/zug1/kyoto-kat-kit/v1/images/`
- Portable archive: `/Volumes/zug1/kyoto-kat-kit/kyoto-kat-references-v1.tar.gz`
- Verification: `python3 /Volumes/zug1/kyoto-kat-kit/v1/validate.py /Volumes/zug1/kyoto-kat-kit/v1`

These paths require this Mac and the mounted zug1 drive. No hosted download has been published.
For remote Opus execution, transfer the complete portable archive before starting.
The 3D checklist below remains unchecked intentionally: this issue assigns that work to Opus.
Read per-item review notes for contextual animals, optional dressing and construction corrections.
